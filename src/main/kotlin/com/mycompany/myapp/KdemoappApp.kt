...
class KdemoappApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes kdemoapp.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KdemoappApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KdemoappApp::class.java)
